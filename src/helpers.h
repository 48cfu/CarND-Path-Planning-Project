...
inline constexpr double MPH2mps(double velocity_in_miles_per_hour) { return velocity_in_miles_per_hour / 2.24; }
inline constexpr double mps2MPH(double velocity_in_meters_per_second) { return velocity_in_meters_per_second * 2.24; }
